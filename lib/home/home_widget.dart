                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: Image.asset(
                            'assets/images/splash_screen_light_high_quality.png',
                          ).image,
                        ),
                      ),
                    ),
                                      ...
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          'ticket': serializeParam(
                                            listViewTicketRecord.ticketid,
                                            ParamType.int,
                                          ),
                                          'desc': serializeParam(
                                            listViewTicketRecord.description,
                                            ParamType.String,
                                          ),
                                          'address': serializeParam(
                                            listViewTicketRecord.address,
                                            ParamType.String,
                                          ),
                                          'photo': serializeParam(
                                            listViewTicketRecord.photo2,
                                            ParamType.String,
                                          ),
                                        }.withoutNulls,
                                      );
