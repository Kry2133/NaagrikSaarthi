                ...
                children: [
                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Title of your report',
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          await launchURL('https://g.co/kgs/WQiRhpi');
                        },
                        child: Container(
                          width: 367.0,
                          height: 176.0,
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: Image.asset(
                                'assets/images/Screenshot_2024-04-11_at_11.58.27_AM.png',
                              ).image,
                            ),
                                ...
                                onTap: () async {
                                  ...
                                  var confirmDialogResponse = await showDialog<
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title: const Text('Description Picture'),
                                            content:
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await TicketRecord.collection.doc().set({
                          ...createTicketRecordData(
                            address: _model.addressTextController.text,
                            photo2: _model.uploadedFileUrl2,
                            ticketname: _model.titleTextController.text,
                            ticketid: random_data.randomInteger(1000, 10000),
                        ...
                        context.pushNamed('ticketConfirm');
                      },
                      text: 'Create Issue',
                      icon: const Icon(
                        Icons.receipt_long,
